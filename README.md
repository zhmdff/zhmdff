...
**Backend Architect · Full Stack Developer · Game Developer**

[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=13&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=440&lines=Building+scalable+backend+systems;Crafting+indie+games+with+Unity;C%23+%2B+Node.js+%2B+everything+in+between)](https://git.io/typing-svg)
...
public class Developer
{
    ...
    public string[] Stack => ["C#", "ASP.NET Core", "Node.js", "TypeScript", "Unity"];
    public string Focus   => "Scalable systems & indie games";
}
```
